#
#  Be sure to run `pod spec lint PassWord.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "PassWord"
  s.version      = "0.0.1"
  s.summary      = "thie is my passwordsdk"
...
s.homepage     = "http://www.baidu.com"
  ...
  s.author             = { "xiao" => "xiaosh@chebeilicai.com" }
  # Or just: s.author    = "xiao"
  # s.authors            = { "xiao" => "xiaosh@chebeilicai.com" }
